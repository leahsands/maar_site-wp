...
class floating_social_bar {
    ...
    public function do_social_bar_output( $services, $atts = array(), $manual = false ) {
        ...
        $css     = '
            #fsb-social-bar { width: 100%; border-bottom: 1px solid #dbdbdb; border-top: 1px solid #dbdbdb; padding: 10px; margin: 0px 0 20px 0; float: left; position: relative; clear: both; text-align:center; }
