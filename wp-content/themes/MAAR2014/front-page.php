...
<div class="slide-notify">
	<a href="#" class="hide"><i class="icon-cancel"></i></a>
	<div id="slide">
		<a href="<?php echo esc_url( get_permalink( get_page_by_path( 'join-maar' ) ) ); ?>">Join MAAR</a>
	</div>
</div>
...
<div class="row mrkt-data main-body">
	...
	<section class="sixteen colgrid">
		<ul class="row">
			...
			<li class="ttip two columns" data-tooltip="A smart, bite-sized video of your local market." alt="">
				<p>The Skinny</p>
