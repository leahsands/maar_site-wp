<?php
	...
	?>
	  <p>
		<label for="<?php echo $this->get_field_id('textarea'); ?>"><?php _e('Message', 'custom_dashboard_notify'); ?></label><br />
		<input id="<?php echo $this->get_field_id('textarea'); ?>" name="<?php echo $this->get_field_name('textarea'); ?>" type="text" value="<?php echo $textarea; ?>" />
	  </p>
	  <p>
		<label for="<?php echo $this->get_field_id('checkbox'); ?>"><?php _e('Is this an alert?', 'custom_dashboard_notify'); ?></label>
	  ...
	  // display widget
		function widget($args, $instance) {
		   ...
		   if( $checkbox AND $checkbox == '1' ) {
		     echo '<div class="row main-body notify active"><div class="twelve columns">';
		   }
		   else {
		   echo '<div class="row main-body notify"><div class="twelve columns">';
		   }
	...
	function blog_pagination() {
	    ...
	    echo '<section class="six columns"><div class="alignright">' . "\n";
	...
	function my_admin() {
	    ...
	    add_meta_box( 'report_year_meta_box',
	        'Report Year',
	        'display_report_year_meta_box',
	        'report_html', 'normal', 'high'
	    );
	}
