...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<meta name="verify-v1" content="6ICAefFJ83Bk0CEtBLAQ9ngQv3UIvHiKddPwzUtXrYA=">
	<meta name="description" content="The Minneapolis Area Association of REALTORS is the local real estate resource for a global market.">
	<meta name="keywords" content="minneapolis area association of realtors, minneapolis realtor association, minneapolis board of realtors, minneapolis realtor board, minneapolis realtor, minneapolis realtors, minneapolis real estate, minnesota realtor, minnesota real estate, twin cities realtors, twin cities real estate, saint paul real estate, st paul real estate, st paul realtor, saint paul realtor, northstarmls, maar, the 100, the 200, 10k, 10k research, 10k marketing, 10k research and marketing">
	...
	<meta property="og:image" content="http://www.mplsrealtor.com/wp-content/themes/MAAR2014/img/assets/MAARlogo.png">
	<meta property="og:description" content="The Minneapolis Area Association of REALTORS is the local real estate resource for a global market.">
	<meta property="og:title" content="Minneapolis Area Association of REALTORS">

	<!-- Google+ Metadata /-->
	<meta itemprop="name" content="Minneapolis Area Association of REALTORS">
	<meta itemprop="description" content="The Minneapolis Area Association of REALTORS is the local real estate resource for a global market.">
	<meta itemprop="image" content="http://www.mplsrealtor.com/wp-content/themes/MAAR2014/img/assets/MAARlogo.png">
...
<li><a href="<?php echo esc_url( get_permalink( get_page_by_path( 'keybox-system' ) ) ); ?>">Supra Lockbox Exchange</a></li>
	  				</ul>
	  			</section>
	  		</section> <!-- / side-scroll -->
			</nav>
				...
				<section class="side-scroll">
  				<center><form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
					...
					<div class="row side-contact">
							...
							<p>Created by <a href="http://10kresearch.com" target="_blank">10K Research and Marketing</a></p>
					</div>
	  		</section> <!-- / side-scroll -->
			</nav>
		<!-- /MOBILE RIGHT NAV -->
